...
# Java jdk 8, Maven 3.3, Gradle 4.8
RUN INSTALL_PKGS="tar unzip bc which lsof java-1.8.0-openjdk java-1.8.0-openjdk-devel rsync" && \
...
LABEL io.k8s.description="Platform for building Java (fatjar) applications with maven or gradle" \
      ...
      io.openshift.tags="builder,maven-3,gradle-4.8,java,microservices,fatjar"
